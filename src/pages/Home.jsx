  ...
  return (
    <div className="container mt-1 fs-5">
      <div className="card border-0 p-4">
        ...
        <p className="fs-5">
          The definition of multiplicative inverse of A mod B, for two positive integers A and B, is not very far from the definition of multiplicative inverse of an integer. It is an integer x such that when we multiply x and A mod B we get 1.
        </p>
